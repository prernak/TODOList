...
public class RSA {
 ...
 /* public synchronized void generateKeys() {
  ...
  public static void main(String[] args){
	 RSA rsa=new RSA();
	 rsa.decryptPassword("reda");
  }
  /** Trivial test program. */
  public  void decryptPassword(String passwordCypher) {
	  ...
	  Properties prop = new Properties();
		...
		try {
			...
			publicKey=prop.getProperty("encryptKey");
	  ...
	  this.e=new BigInteger(publicKey);
	  
		String s=this.encrypt("christ");
    ...
    this.d=new BigInteger(privateKey);
	   ...
	   BigInteger plaintext = this.decrypt(new BigInteger(passwordCypher));
